    ...
    <div className="space-y-4">
      ...
      <Tabs defaultValue="overview" className="space-y-4">
        ...
        <TabsContent value="overview" className="space-y-4">
          {/* Task Completion Graph at the top */}
          <div className="grid gap-4 md:grid-cols-2">
            ...
            {/* <Card>
              <CardHeader>
                ...
                <CardDescription>Хэлтсүүдийн даалгаврын гүйцэтгэл</CardDescription>
              </CardHeader>
              <CardContent>
                <Suspense fallback={<Skeleton className="h-[300px] w-full" />}>
          ...
          {/* <div className="grid gap-4 md:grid-cols-2">
            <Card>
              <CardHeader>
                <CardTitle>Чухал зэргээр</CardTitle>
                <CardDescription>Даалгаврын чухал зэргийн харьцаа</CardDescription>
              </CardHeader>
              <CardContent>
                <Suspense fallback={<Skeleton className="h-[300px] w-full" />}>
            ...
            <Card>
              <CardHeader>
                <CardTitle>Даалгаврын чиг хандлага</CardTitle>
                <CardDescription>Сүүлийн 6 сарын даалгаврын чиг хандлага</CardDescription>
              </CardHeader>
              <CardContent>
                <Suspense fallback={<Skeleton className="h-[300px] w-full" />}>
                  <TaskTrendChart />
