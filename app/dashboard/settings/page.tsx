  ...
  return (
    <div className="space-y-6 p-4 pt-6 md:p-8">
      <div>
        ...
        <p className="text-sm text-muted-foreground">Хэрэглэгчийн профайл болон системийн тохиргоог өөрчлөх</p>
      </div>
      <Separator />
      <div className="flex flex-col space-y-8 lg:flex-row lg:space-x-12 lg:space-y-0">
        <aside className="-mx-4 lg:w-1/5">
          <nav className="flex space-x-2 lg:flex-col lg:space-x-0 lg:space-y-1">
            <a href="#" className="inline-flex items-center rounded-md bg-muted px-3 py-2 text-sm font-medium">
              Профайл
            </a>
            <a
              href="#"
