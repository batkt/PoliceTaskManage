      ...
      <div className="flex flex-1 items-center justify-between md:ml-64">
        {showMobileSearch ? (
          <div className="flex w-full items-center md:hidden">
            <Input placeholder="Хайх..." className="mr-2" autoFocus onBlur={() => setShowMobileSearch(false)} />
                ...
                <DropdownMenuContent className="w-56" align="end" forceMount>
                  <DropdownMenuLabel className="font-normal">
                    <div className="flex flex-col space-y-1">
                      ...
                      <p className="text-xs leading-none text-muted-foreground truncate">batbold@police.gov.mn</p>
                    </div>
                  </DropdownMenuLabel>
                  <DropdownMenuSeparator />
                  <DropdownMenuItem onClick={() => router.push("/dashboard/profile")}>Профайл</DropdownMenuItem>
                  <DropdownMenuItem onClick={() => router.push("/dashboard/settings")}>Тохиргоо</DropdownMenuItem>
                  <DropdownMenuSeparator />
                  <DropdownMenuItem onClick={() => router.push("/")}>Гарах</DropdownMenuItem>
                </DropdownMenuContent>
              </DropdownMenu>
            </div>
          </>
