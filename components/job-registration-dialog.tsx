...
export function JobRegistrationDialog({
  ...
  useEffect(() => {
    if (editJob) {
      form.reset({
        ...
        type: editJob.type || '',
        assigner: editJob?.assigner?.[0]._id || '',
  ...
  function onSubmit(values: FormValues) {
    ...
    setTimeout(() => {
      ...
      //   toast({
      //     title: editJob
      //       ? 'Ажил амжилттай шинэчлэгдлээ'
      //       : 'Ажил амжилттай бүртгэгдлээ',
      //     description: editJob
              ...
              <div className="grid gap-4 py-4 md:grid-cols-2">
                ...
                <Controller
                  ...
                  render={({ field, fieldState: { error } }) => {
                    return (
                      <div className="space-y-2">
                        <Label htmlFor="assigner">Хариуцах алба хаагч</Label>
                ...
                {/* <div>
                    ...
                    {fileSelected && (
                      <p className="mt-1 text-xs text-muted-foreground truncate">
                        Сонгосон файл: {fileSelected.name}
                      </p>
                    )}
                  </div>
                ...
                <div className="md:col-span-2">
                  <Controller
                    ...
                    render={({ field, fieldState: { error } }) => {
                      return (
                        <div className="space-y-2">
                          <Label htmlFor="marking">Цохолт</Label>
                          <Textarea
                            id="marking"
                            placeholder="Цохолт"
                          ...
                          <div className="flex items-center justify-between">
                            <div className="flex items-center gap-2">
                              ...
                              <span className="text-sm">
                                Бичлэгийн хугацаа: {formatTime(recordingTime)}
                              </span>
                            </div>
                            <Button
                              type="button"
                        ...
                        <div className="space-y-2">
                          <div className="flex items-center justify-between">
                            <div className="flex items-center gap-2">
                              ...
                              <span className="text-sm">
                                {isRecording
                                  ? `Бичиж байна: ${formatTime(recordingTime)}`
                                  : 'Дуу бичлэг хийх'}
                              </span>
                            </div>
                          </div>
                    ...
                    render={({ field }) => (
                      <FormItem className="flex flex-row items-center justify-between rounded-lg border p-3 shadow-sm">
                        <div className="space-y-0.5">
                          ...
                          <FormDescription>
                            Энэ ажил яаралтай эсэхийг тодорхойлно
                          </FormDescription>
                        </div>
                        <FormControl>
                          <Switch
