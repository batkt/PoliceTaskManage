      ...
      <CommandDialog open={open} onOpenChange={setOpen}>
        ...
        <CommandList>
          ...
          <CommandGroup heading="Хуудсууд">
            ...
            <CommandItem onSelect={() => runCommand(() => router.push("/dashboard/officers"))}>
              <Search className="mr-2 h-4 w-4" />
              <span>Цагдаагийн бүртгэл</span>
            </CommandItem>
            <CommandItem onSelect={() => runCommand(() => router.push("/dashboard/statistics"))}>
              <Search className="mr-2 h-4 w-4" />
              <span>Статистик</span>
            </CommandItem>
          </CommandGroup>
          <CommandGroup heading="Үйлдлүүд">
            <CommandItem onSelect={() => runCommand(() => router.push("/dashboard/jobs?status=planned"))}>
              <Search className="mr-2 h-4 w-4" />
              <span>Эхлээгүй ажлууд</span>
            </CommandItem>
            <CommandItem onSelect={() => runCommand(() => router.push("/dashboard/jobs?status=assigned"))}>
              <Search className="mr-2 h-4 w-4" />
              <span>Хуваарилагдсан ажлууд</span>
            </CommandItem>
            <CommandItem onSelect={() => runCommand(() => router.push("/dashboard/officers/new"))}>
              <Search className="mr-2 h-4 w-4" />
