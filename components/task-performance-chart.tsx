  ...
  return (
    <div className="space-y-4">
      <div className="flex items-center justify-between">
        <div className="text-sm text-muted-foreground">Ажилтнуудын даалгаврын гүйцэтгэлийн харьцуулалт</div>
        <Dialog open={isDialogOpen} onOpenChange={setIsDialogOpen}>
          ...
          <DialogContent className="max-w-4xl">
            <DialogHeader>
              ...
              <DialogDescription>Бүх ажилтнуудын даалгаврын гүйцэтгэлийн дэлгэрэнгүй мэдээлэл</DialogDescription>
            </DialogHeader>
